...
import LeaveForm from "components/CustomModals/leaveFormModal/LeaveForm";
...
const LeaveRequest = () => {
  ...
  return (
    <>
      ...
      <LeaveForm modal={leaveFormModal} toggle={toggleLeaveFormModal} />
    </>
  );
};
